    ...
    case fr of
      ...
      _otherwise -> do
          ...
          defaultLayout $ do
              ...
              $(widgetFile "businesses/workspaces/edit")
...
getWorkspaceR uid bid wid = do
    ...
    defaultLayout $ do
        setTitleI MsgWorkspace
        $(widgetFile "businesses/workspaces/workspace")
    ...
    case fr of
      ...
      _otherwise -> do
          ...
          defaultLayout $ do
              setTitleI MsgWorkspace
              idFormWorkspace <- newIdent
              $(widgetFile "businesses/workspaces/new")
...
getWorkspacesR uid bid = do
    ...
    defaultLayout $ do
        ...
        idFabAdd <- newIdent
        $(widgetFile "businesses/workspaces/workspaces")
...
getBusinessR uid bid = do
    ...
    defaultLayout $ do
        ...
        $(widgetFile "businesses/business")
...
getBusinessesR uid = do
    ...
    defaultLayout $ do
        ...
        idFabAdd <- newIdent
        $(widgetFile "businesses/businesses")
